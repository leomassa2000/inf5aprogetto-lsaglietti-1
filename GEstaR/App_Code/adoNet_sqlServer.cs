...
namespace adoNetWebSQlServer
{
    ...
    {
        private static string cnString = @"Data Source = RO0T;
                            Initial Catalog=ER;
                            User id=sa;
                            Password=Luca2001; ";
        ...
        public static void impostaConnessione()
        {
            /*cnString = @"Data Source = RO0T;
                            Initial Catalog=ER;
                            User id=sa;
                            Password=Luca2001; ";*/
        ...
        public int eseguiNonQuery(SqlCommand cmd)
        {
            ...
            adp1.MissingSchemaAction = MissingSchemaAction.AddWithKey;
            apriConnessione();
            ris = cmd.ExecuteNonQuery();
            chiudiConnessione();
            this.cmd.Parameters.Clear();
        ...
        public string eseguiScalar(SqlCommand cmd)
        {
            Object obj;
            string ris = string.Empty;
            cmd.Connection = cn;
